...
//
// Two passes: `shapeOf` reduces a value to a structural Shape, merging every
// element of an array into one Shape; `toTypeScript` names the object shapes
// and prints them as interfaces.
